	...
	public function place_order()
	{
		...
		if (flock($lock, LOCK_EX)) {
			...
			if ($insert) {
				...
				if (($this->settings->info('ativopay') == 1) &&  $total_amount > 0) {
					ativopay_generate_pix($oid, $total_amount, $customer_name, $customer_email, $order_expiration, $customer_phone);
				}
				...
				if (($this->settings->info('bestfy') == 1) &&  $total_amount > 0) {
					bestfy_generate_pix($oid, $total_amount, $customer_name, $customer_email, $order_expiration);
				}
