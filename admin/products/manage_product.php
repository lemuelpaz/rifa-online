        ...
        <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
            <div class="flex">
                <ul class="flex" id="tabs">
                    ...
                    <li class="mr-1">
                        <a href="#tab5" class="dark:text-gray-300 dark:border-gray-600 dark:bg-gray-800 inline-block py-2 px-4 font-semibold border rounded-t text-gray-700">Barra P.</a>
                    </li>
                    <li class="mr-1">
                    ...
                    <li class="mr-1">
                        <a href="#tab7" class="dark:text-gray-300 dark:border-gray-600 dark:bg-gray-800 inline-block py-2 px-4 font-semibold border rounded-t text-gray-700">B. Premiados</a>
                    </li>
                    <li class="mr-1">
                    ...
                    <div id="tab1" class="tabcontent text-gray-700 dark:text-gray-400">
                        <div class="grid gap-6 md:grid-cols-2 xl:grid-cols-2 mt-4">
                            <label class="block text-sm">
                                <span class="text-gray-700 dark:text-gray-400">Titulo da Campanha</span>
                            ...
                            <label class="block text-sm">
                                <span class="text-gray-700 dark:text-gray-400">Subtitulo da Campanha</span>
                        ...
                        <label class="block mt-4 text-sm"><span class="text-gray-700 dark:text-gray-400">Descrição da Campanha</span>
...
<?= isset($description) ? $description : '' ?>
                        ...
                        <div class="grid gap-6 md:grid-cols-2 xl:grid-cols-6 mt-4 qtd-select">
                            <div class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
                                <div>
                                    <p class="mb-2 text-sm font-medium text-gray-600 dark:text-gray-400">Pacote Bilhete 1</p>
                            ...
                            <div class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
                                <div>
                                    <p class="mb-2 text-sm font-medium text-gray-600 dark:text-gray-400">Pacote Bilhete 2</p>
                            ...
                            <div class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
                                <div>
                                    <p class="mb-2 text-sm font-medium text-gray-600 dark:text-gray-400">Pacote Bilhete 3*</p><input name="qty_select_3" id="qty_select_3" type="number" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" placeholder="50" value="<?= isset($qty_select_3) ? $qty_select_3 : 50 ?>" />
                                </div>
                            </div>
                            <div class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
                                <div>
                                    <p class="mb-2 text-sm font-medium text-gray-600 dark:text-gray-400">Pacote Bilhete 4</p>
                            ...
                            <div class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
                                <div>
                                    <p class="mb-2 text-sm font-medium text-gray-600 dark:text-gray-400">Pacote Bilhete 5</p>
                            ...
                            <div class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
                                <div>
                                    <p class="mb-2 text-sm font-medium text-gray-600 dark:text-gray-400">Pacote Bilhete 6</p>
                        ...
                        <div class="grid gap-6 md:grid-cols-2 xl:grid-cols-3 mt-4"><label class="block mt-4 text-sm qtd-numeros"><span class="text-gray-700 dark:text-gray-400">Quantidade de números</span><select name="qty_numbers" id="qty_numbers" class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-select focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray">
                                    <option value="100" <?= isset($qty_numbers) && $qty_numbers == '100' ? 'selected' : '' ?>>100 Bilhete - 00 à 99 </option>
                                    <option value="1000" <?= isset($qty_numbers) && $qty_numbers == '1000' ? 'selected' : '' ?>>1 mil Bilhete - 000 a 999 </option>
                                    <option value="10000" <?= isset($qty_numbers) && $qty_numbers == '10000' ? 'selected' : '' ?>>10 mil Bilhete - 0000 a 9999 </option>
                                    <option value="100000" <?= isset($qty_numbers) && $qty_numbers == '100000' ? 'selected' : '' ?>>100 mil Bilhete - 00000 a 99999 </option>
                                    <option value="1000000" <?= isset($qty_numbers) && $qty_numbers == '1000000' ? 'selected' : '' ?>>1 milhão Bilhete - 000000 a 999999 </option>
                                    <option value="10000000" <?= isset($qty_numbers) && $qty_numbers == '10000000' ? 'selected' : '' ?>>10 milhôes Bilhete - 0000000 à 9999999 </option>
                                </select>
                            </label>
                            <label class="block mt-4 text-sm"><span class="text-gray-700 dark:text-gray-400">Valor por cada Bilhete</span><input name="price" id="price" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" placeholder="10,00" value="<?= isset($price) ? $price : '' ?>" />
                            </label>
                    ...
                    <div id="tab3" class="tabcontent text-gray-700 dark:text-gray-400 hidden">
                        ...
                        <label class="block mt-4 text-sm"><span class="text-gray-700 dark:text-gray-400">Utilizar o Bilhete em dobro?</span>
                        </label>
                        <div class="can-toggle">
                    ...
                    <div id="tab4" class="tabcontent text-gray-700 dark:text-gray-400 hidden">
                        ...
                        <div class="ranking_qty"><label class="block mt-4 text-sm"><span class="text-gray-700 dark:text-gray-400">Mostrar a quantidade de bilhetes comprados?</span></label>
                            ...
                            <label class="block mt-4 text-sm"><span class="text-gray-700 dark:text-gray-400">Definir data/hora Top Compradores ?</span>
                            </label>
                            ...
                            <div class="ranking_definido">
                                <label class="block mt-4 text-sm col-span-2">
                                    <span class="text-gray-700 dark:text-gray-400">Data e hora inicial Top Compradores</span>
                                ...
                                <label class="block mt-4 text-sm col-span-2">
                                    <span class="text-gray-700 dark:text-gray-400">Data e hora final Top Compradores</span>
                            ...
                            <label class="block mt-4 text-sm"><span class="text-gray-700 dark:text-gray-400">Mensagem da promoção do Top Compradores *</span><input name="ranking_message" id="ranking_message" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" placeholder="Quem comprar mais Bilhetes, o 1º lugar ganha: R$ " value="<?= isset($ranking_message) ? $ranking_message : 'Quem comprar mais Bilhete, o 1º lugar ganha: R$' ?>" /></label>
                        </div>
                    </div>
                    <div id="tab5" class="tabcontent text-gray-700 dark:text-gray-400 hidden">
                        <label class="block mt-4 text-sm"><span class="text-gray-700 dark:text-gray-400">Exibir barra de progresso?</span>
                        </label>
                ...
                <div id="tab7" class="tabcontent text-gray-700 dark:text-gray-400 hidden">
                    <label class="block mt-4 text-sm">
                        <span class="text-gray-700 dark:text-gray-400">
                            ...
                            <p style="font-size: 13px; color: orange;">
                                Digite o número do bilhete e pressione enter para adicionar
                            </p>
                        </span>
                        <input type="text" id="tags-input" class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-input focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray" placeholder="Pressione Enter para adicionar um Bilhetes">
                    ...
                    <label class="block mt-4 text-sm qtd-minima">
                        ...
                        <input name="cotas_premiadas_descricao" id="cotas_premiadas__descricao" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" value="<?php echo isset($cotas_premiadas_descricao) ? $cotas_premiadas_descricao : ''; ?>" placeholder="Além do prêmio principal, temos bilhetes premiadas esperando por você. " />
                    </label>

                    <label class="block mt-4 text-sm">
                        <span class="text-gray-700 dark:text-gray-400 ">Habilitar bloqueio dos Bilhetes?</span>
                    </label>
                    ...
                    <div class="block glass mt-4 text-sm status_cotas" style="">
                        ...
                        <p id="mensagem_porcentagem" style="color:orange" class="italic  text-xs"> Apague o Bilhete que deseja liberar para
                            venda
                        </p>
                ...
                <div id="tab8" class="tabcontent text-gray-700 dark:text-gray-400 hidden">
                    ...
                    <div class="flex">
                        <label class="block mt-4 text-sm"><span class="text-gray-700 dark:text-gray-400">Quantidades de Bilhetes</span>
                        ...
                        <label class="block mt-4 text-sm"><span class="text-gray-700 dark:text-gray-400">% Desconto de cada Bilhetes</span>
                ...
                <div id="tab9" class="tabcontent text-gray-700 dark:text-gray-400 hidden">
                    ...
                    <label class="block mt-4 text-sm">
                        <span class="text-gray-700 dark:text-gray-400">
                            Bilhete Premiados da Roleta
                            <p style="font-size: 13px; color: orange;">
                                Digite o número do Bilhete e pressione enter para adicionar
                            </p>
                        </span>
                        <input type="text" id="tags-input_roleta" class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-input focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray" placeholder="Pressione Enter para adicionar um Bilhete">
                            ...
                            if (isset($cotas_premiadas_premios_roleta)) {
                                ...
                                foreach ($cotas_premiadas_premios_array_roleta as $cota_roleta) {
                                    ...
                                    if ($cota_roleta != '' && $cota_roleta != ':') {
                                        echo "<div id='p$id_roleta' data-tipo='$tipo_roleta' data-premio='$cota_roleta'  class='tag  $tipo_roleta'>$cota_roleta <span class='remove-premio'>x</span></div>";
                                    }
                                }
                            }
                            ?>
                    ...
                    <div class="block glass mt-4 text-sm status_cotas_roleta">
                        <span class="text-gray-700 dark:text-gray-400 ">
                            Bilhete bloqueados da roleta
                        </span>
                        <p id="mensagem_porcentagem_roleta" style="color:orange" class="italic  text-xs"> Apague o bilhete que deseja liberar
                        </p>
                        ...
                        ?>
                                <div class="grupo-roleta">
                                    <div class="roleta dark:border-gray-600 text-gray-700 dark:text-gray-400"><span class="discount-number"><?= $count ?></span> Roletas
                                        <label class="block mt-4 text-sm"><span class="text-gray-700 dark:text-gray-400">Bilhetes:</span>
                            ...
                            <div class="grupo-roleta">
                                <div class="roleta dark:border-gray-600 text-gray-700 dark:text-gray-400"><span class="discount-number">1</span> Roletas
                                    <label class="block mt-4 text-sm">
                                        <span class="text-gray-700 dark:text-gray-400">Bilhetes:</span>
                ...
                <div id="tab10" class="tabcontent text-gray-700 dark:text-gray-400 hidden">
                    ...
                    <label class="block mt-4 text-sm">
                        <span class="text-gray-700 dark:text-gray-400">
                            Bilhetes Premiados das Caixinhas
                            <p style="font-size: 13px; color: orange;">
                                Digite o número do bilhete e pressione enter para adicionar
                            </p>
                        </span>
                        <input type="text" id="tags-input_box" class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-input focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray" placeholder="Pressione Enter para adicionar um bilhete">
                            ...
                            if (isset($cotas_premiadas_premios_box)) {
                                ...
                                foreach ($cotas_premiadas_premios_array_box as $cota_box) {
                                    ...
                                    if ($cota_box != '' && $cota_box != ':') {
                                        echo "<div id='p$id_box' data-tipo='$tipo_box' data-premio='$cota_box'  class='tag  $tipo_box'>$cota_box <span class='remove-premio'>x</span></div>";
                                    }
                                }
                            }
                            ?>
                    ...
                    <label class="block mt-4 text-sm qtd-minima">
                        <span class="text-gray-700 dark:text-gray-400">Descrição</span>
                        <input name="cotas_premiadas_descricao_box" id="cotas_premiadas__descricao" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" value="<?php echo isset($cotas_premiadas_descricao_box) ? $cotas_premiadas_descricao_box : ''; ?>" placeholder="Além do prêmio principal, temos bilhetes premiadas esperando por você. " />
                    </label>

                    <label class="block mt-4 text-sm">
                        <span class="text-gray-700 dark:text-gray-400 ">Habilitar Bloqueio de bilhete das Caixinhas?</span>
                    </label>
                    <div class="can-toggle" style="margin-top:4px">
                        <input
                    ...
                    <div class="block glass mt-4 text-sm status_cotas_box">
                        <span class="text-gray-700 dark:text-gray-400 ">
                            Bilhetes bloqueados das Caixinhas
                        </span>
                        <p id="mensagem_porcentagem_box" style="color:orange" class="italic  text-xs"> Apague o bilhete que deseja liberar para
                            venda
                        </p>
                    ...
                    <div id="boxs" class="boxs ">
                        ...
                        ?>
                                <div class="grupo-box">
                                    <div class="box dark:border-gray-600 text-gray-700 dark:text-gray-400"><span class="discount-number"><?= $count ?></span> Caixnhas
                                        <label class="block mt-4 text-sm"><span class="text-gray-700 dark:text-gray-400">Bilhetes:</span>
                ...
                <div id="tab11" class="tabcontent text-gray-700 dark:text-gray-400 hidden">
                    <label class="block mt-4 text-sm">
                        <span class="text-gray-700 dark:text-gray-400">Habilitar Maior/Menor Bilhete?</span>
                    </label>
                    <div style="margin-top:4px" class="can-toggle">
                    ...
                    <label class="block mt-4 text-sm">
                        <span class="text-gray-700 dark:text-gray-400">Maior/Menor Bilhete Diária?</span>
                    </label>
                    <div style="margin-top:4px" class="can-toggle">
    ...
    $(document).ready(function() {
        ...
        $(add_button_roleta).click(function(e) {
            ...
            if (y < max_fields_roleta) {
                y++;
                $(wrapper_roleta).append('<div class="grupo-roleta"><div class="roleta dark:border-gray-600 text-gray-700 dark:text-gray-400"><span class="discount-number">' + y + '</span> Roletas <label class="block mt-4 text-sm"> <span class="text-gray-700 dark:text-gray-400">Bilhetes:</span> <input type="text" name="roleta_amount[]" class="discount_qty block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" placeholder="' + y + '0"> </label><label class="block mt-4 text-sm"> <span class="text-gray-700 dark:text-gray-400">Quantidade:</span> <input type="text" name="roleta_qty[]" class="discount_qty block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" placeholder="' + y + '0"> </label> <label class="remove_field_roleta block mt-4 text-sm"><span class="bg-red-500 px-5 py-3 font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple">Remover</span></label><br></div></div>');
            }
            if (y == max_fields_roleta) {
        ...
        $(add_button_box).click(function(e) {
            ...
            if (y < max_fields_box) {
                w++;
                $(wrapper_box).append('<div class="grupo-roleta"><div class="roleta dark:border-gray-600 text-gray-700 dark:text-gray-400"><span class="discount-number">' + w + '</span> Boxs <label class="block mt-4 text-sm"> <span class="text-gray-700 dark:text-gray-400">Bilhetes:</span> <input type="text" name="box_amount[]" class="discount_qty block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" placeholder="' + w + '0"> </label> <label class="block mt-4 text-sm"> <span class="text-gray-700 dark:text-gray-400">Quantidade:</span> <input type="text" name="box_qty[]" class="discount_qty block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" placeholder="' + w + '0"> </label><label class="remove_field_box block mt-4 text-sm"><span class="bg-red-500 px-5 py-3 font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple">Remover</span></label><br></div></div>');
            }
            if (w == max_fields_box) {
                $('.add_field_box').hide();
            }
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        $('#tags-input').on('keypress', function(e) {
            if (e.which === 13) { // Enter key pressed
                ...
                if (count >= 30) {
                    alert('Você atingiu o limite de Bilhetes premiados, o máximo é 30')
                    return false;
                }
                var tagText = $(this).val().trim();
                var tipoText = 'premiada';
                var premioText = prompt('Digite o prêmio para o bilhete "' + tagText + '":');
        ...
        $('#tags-input_roleta').on('keypress', function(e) {
            if (e.which === 13) { // Enter key pressed
                ...
                if (count >= 9) {
                    alert('Você atingiu o limite de bilhete premiados, o máximo é 9')
                    return false;
                }
                var tagText = $(this).val().trim();
                var tipoText = 'premiada';
        ...
        $('#tags-input_box').on('keypress', function(e) {
            if (e.which === 13) { // Enter key pressed
                ...
                if (count >= 30) {
                    alert('Você atingiu o limite de bilhete premiados, o máximo é 30')
                    return false;
                }
                var tagText = $(this).val().trim();
                var tipoText = 'premiada';
