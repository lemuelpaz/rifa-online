            ...
            <div class="container-600 font-mdd">
               <div style="text-align-last: justify; padding: 10 0 10 0;">
                  ...
                  <button type="button" aria-label="Menu" class="btn btn-link text-white font-lgg ps-0" data-bs-toggle="modal" data-bs-target="#mobileMenu" style="margin-top:5px">
                     <svg style="font-size: 30px;" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" class="MuiBox-root css-0 iconify iconify--eva" sx="[object Object]" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24">
                  ...
                  <div class="container-600">
                     ...
                     <nav class="nav-vertical nav-submenu font-xs mb-2">
                        <ul>
                           ...
                           <li><a class="" style="color: rgb(255,255,255,0.8); font-weight: 600;" alt="Meus Números" href="/meus-numeros"><i class="icone bi bi-card-list"></i><span>Meus números</span></a></li>
                           <li><a alt="Afiliado" class="text-white" href="/user/afiliado"><i class="icone bi bi-person"></i><span>Afiliados</span></a></li>
                           <?php if ($user_id): ?>
                           ...
                           <li><a href="<?php echo BASE_URL; ?>contato" class="" style="color: rgb(255,255,255,0.8); font-weight: 600;"><i class="icone bi bi-chat-dots-fill"></i><span>Fale Conosco</span></a></li>
                           <?php if ($user_id): ?>
                           ...
                           <?php else: ?>
                              <li><a alt="Entrar" class="btn btn-success justify-content-center" style="color: rgb(255,255,255,0.8); font-weight: 600;" href="/login"><i class="bi bi-box-arrow-in-right me-2"></i><span>Entrar</span></a></li>
                           <?php endif; ?>
...
<script>
// Bloqueio básico de F12, Ctrl+Shift+I, Ctrl+U e clique direito
