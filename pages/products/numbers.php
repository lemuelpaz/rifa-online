...
if ($user_id) {
    echo '            <button id="add_to_cart" data-bs-toggle="modal" data-bs-target="#newCheckoutModal" class="btn btn-success w-100 py-3">' .
        "\r\n" .
        "            ";
} else {
    echo '               <span id="add_to_cart"></span>' .
        "\r\n" .
        '               <button data-bs-toggle="modal" data-bs-target="#newCheckoutModal" class="btn btn-success w-100 py-3">' .
        "\r\n" .
        "               ";
}
